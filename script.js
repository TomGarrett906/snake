...
const mobilePlayButton = document.querySelector('.mobile-play');
const mobileUpButton = document.querySelector('.mobile-up');
const mobileDownButton = document.querySelector('.mobile-down');
const mobileLeftButton = document.querySelector('.mobile-left');
const mobileRightButton = document.querySelector('.mobile-right');
